...
export default function ModalViewInvitations({
  isOpen,
  close,
  invitations,
  deleteInvitation,
          ...
          <ul className="my-4 space-y-3 w-full">
            {invitations.length === 0
              ...
              : invitations.map((invitation) => {
                  const inviter = createUserProfile(invitation.inviter);
                  return (
                    <li key={invitation.id} className="flex-1 space-x-4 w-full">
                      ...
                      >
                        ...
                        <span className="flex-1 ms-3 font-semibold">
                          {inviter.nickName}{" "}
                          <span className="font-normal">invite you to </span>
